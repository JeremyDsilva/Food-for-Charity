...
s_a[236] = "'Ajman|Abu Dhabi|Al Fujayrah|Sharjah|Dubai|Ra's al Khaymah|Umm al Qaywayn";
...
function populateStates(countryElementId, cityElementId) {

    var selectedCountryIndex = document.getElementById(countryElementId).selectedIndex;

    var stateElement = document.getElementById(cityElementId);
...
function populateCountries(countryElementId, cityElementId) {
    ...
    if (cityElementId) {
        countryElement.onchange = function() {
            populateStates(countryElementId, cityElementId);
        };
    }
}